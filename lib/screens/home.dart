...
import 'package:oreo_sign/dummy_data/data.dart';
import 'package:oreo_sign/screens/sign.dart';
...
class _HomePageState extends State<HomePage> {
  List<String> categories = ["General", "Travel", "Sport", "Transport"];
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return SpecialistTile(
                        ...
                        noOfDoctors: specialities[index].noOfQuestions,
...
class CategoryTile extends StatefulWidget {
  ...
  CategoryTile({this.category, this.isSelected, this.context});
